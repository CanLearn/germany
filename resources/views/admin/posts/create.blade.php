                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form action="{{ route('panel.posts.store')  }}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="radios">
                                        <label class="label_radio" for="radio-02">
                                            <input name="confirmation_post"  id="radio-02" value="body" type="radio" /> body
                                        </label>
                                        <label class="label_radio" for="radio-03">
                                            <input name="confirmation_post"  id="radio-03" value="head" type="radio" /> head
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
